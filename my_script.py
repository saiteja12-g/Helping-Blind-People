...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_path', type=str, default='/home/saiteja/Downloads/IMG_1164.MOV')
    ...
    image_paths = get_image_path(video_path)
    print("Got the whole path")
    input_images = []
    for path in image_paths:
        print("processing images..", image_paths.index(path))
